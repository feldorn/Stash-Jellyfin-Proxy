...
from stash_jellyfin_proxy.middleware.auth import get_client_ip, clear_ip_failures
from stash_jellyfin_proxy.state.stats import record_auth_attempt
from stash_jellyfin_proxy.util.images import generate_text_icon
