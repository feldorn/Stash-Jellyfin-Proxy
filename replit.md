...
- v3.78: Smart stream cleanup - when a client starts a new video, their previous stream is automatically cancelled; prevents abandoned streams from accumulating in dashboard
