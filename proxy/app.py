...
from proxy.errors import ERROR_CONTRACT_HANDLERS
from proxy.middleware.auth import AuthenticationMiddleware
from proxy.middleware.logging import RequestLoggingMiddleware
from proxy.middleware.paths import CaseInsensitivePathMiddleware

# --- Endpoint imports ---
from proxy.endpoints.images import endpoint_image
from proxy.endpoints.items import endpoint_items, endpoint_item_details
from proxy.endpoints.misc import endpoint_display_preferences, endpoint_websocket
from proxy.endpoints.playback import endpoint_playback_info
from proxy.endpoints.search import (
...
from proxy.endpoints.stream import endpoint_stream, endpoint_download, endpoint_subtitle
from proxy.endpoints.stubs import (
...
from proxy.endpoints.system import endpoint_root, endpoint_system_info, endpoint_public_info
from proxy.endpoints.user_actions import (
...
from proxy.endpoints.users import (
...
from proxy.endpoints.views import (
    endpoint_user_views,
